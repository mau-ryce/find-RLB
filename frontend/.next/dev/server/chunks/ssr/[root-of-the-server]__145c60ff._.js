...
"[project]/pages/landlord/listings.tsx [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Listings() {
    ...
    const handleAdd = async ()=>{
        if (newProp.location && newProp.type && newProp.price) {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["propertiesAPI"].create(payload);
            if (response.success) {
                setShowForm(false);
                setNewProp({
                    location: '',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__145c60ff._.js.map